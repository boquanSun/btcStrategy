...
The good news is that our project tells you how to calculate your maxium loss, pointed out the good time to open the position, and provide backtest algorithm to verify strategy. We also used historic price data sets and fundamental data sets to provide the insights of the basis. 
